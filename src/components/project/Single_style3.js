...
export class Single_style3 extends Component {
    render() {
        var slick_slider = {
            dots: false,
            arrow: false,
                    ...
                    <div className="container-xl">
                        <div className="row">
                            ...
                            <div className="title-box text-center">
                                ...
                                <h1 className="title">Single Style 3</h1>
                            ...
                            <div className="col-lg-12 col-xl-8">
                                <Slider className="slick_slider project-single" {...slick_slider} arrows={false} dots={true}>
                                    <div className="featured-thumbnail">
                                        <img src="https://via.placeholder.com/1200X800/444444.jpg" alt="image" className="img-fluid" />
                                    </div>
                                    <div className="featured-thumbnail">
                                        <img src="https://via.placeholder.com/1200X800/444444.jpg" alt="image" className="img-fluid" />
                                    </div>
                            ...
                            <div className="col-lg-12 col-sm-12 col-xl-4">
                                ...
                                <div className="row res-1199-mt-20">
                                    <div className="col-xl-12 col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img className="img-fluid" src="https://via.placeholder.com/1200X800/444444.jpg" title="single-img-twentytwo" alt="single-img-twentytwo" />
                                        </div>{/* ttm_single_image-wrapper end */}
                                    </div>
                                    <div className="col-xl-12 col-lg-6 col-md-6 col-sm-6 mb-20">
                                        {/* ttm_single_image-wrapper */}
                                        <div className="ttm_single_image-wrapper">
                                        <img className="img-fluid" src="https://via.placeholder.com/1200X800/444444.jpg" title="single-img-twentythree" alt="single-img-twentythree" />
                                        </div>{/* ttm_single_image-wrapper end */}
                                    </div>
                                </div>{/* row end*/}
                            </div>
