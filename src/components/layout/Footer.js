                                                                ...
                                                                .map((article, index) => {
                                                                    ...
                                                                    return (
                                                                        <ul className="widget-post ttm-recent-post-list" key={index}>
                                                                            <li>
                                                                                <a href={process.env.PUBLIC_URL + '/article/' + article.slug }><img className="img-fluid" alt={article.title} src={article.image} /></a>
                                                                                <a href={process.env.PUBLIC_URL + '/article/' + article.slug }>{article.title.slice(0, 60) + "..."}</a>
                                                                                <span className="post-date"><i className="fa fa-calendar" />{convertDateToReadableString(article.publish_at.split(".")[0])}</span>
                                                                            </li>
                                                                        </ul>
                                                                    )
                                                                })
