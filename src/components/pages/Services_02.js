                ...
                <section className="ttm-row grid-section clearfix">
                    <div className="container-xl">
                        ...
                        <div className="featured-imagebox featured-imagebox-services style1 mb-30">
                            ...
                            <a className="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-2" href={process.env.PUBLIC_URL + '/It_consultancy'}>Read More <i className="ti ti-angle-double-right" /></a>
                            </div>
                        </div>
                        </div>
                        <div className="col-md-6 col-lg-4">
                        ...
                        <div className="featured-imagebox featured-imagebox-services style1 mb-30">
                            ...
                            <a className="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-2" href={process.env.PUBLIC_URL + '/Data_structuring'}>Read More <i className="ti ti-angle-double-right" /></a>
                            </div>
                        </div>
                        {/* featured-imagebox-services */}
                        </div>
                        ...
                        <div className="featured-imagebox featured-imagebox-services style1 mb-30">
                            ...
                            <div className="featured-content box-shadow">
                            <div className="featured-title">{/* featured-title */}
                                <h5><a href={process.env.PUBLIC_URL + '/Experience_design'}>Experience Design</a></h5>
                            </div>
                            <div className="featured-desc">{/* featured-title */}
                                <p>Reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                            </div>
                            <a className="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-2" href={process.env.PUBLIC_URL + '/Experience_design'}>Read More <i className="ti ti-angle-double-right" /></a>
                            </div>
                        </div>
                        {/* featured-imagebox-services */}
                        </div>
                        ...
                        <div className="featured-imagebox featured-imagebox-services style1 mb-30">
                            ...
                            <div className="featured-content box-shadow">
                            <div className="featured-title">{/* featured-title */}
                                <h5><a href={process.env.PUBLIC_URL + '/Content_engineering'}>Content Engineering</a></h5>
                            </div>
                            <div className="featured-desc">{/* featured-title */}
                                <p>Reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                            </div>
                            <a className="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-2" href={process.env.PUBLIC_URL + '/Content_engineering'}>Read More <i className="ti ti-angle-double-right" /></a>
                            </div>
                        </div>
                        {/* featured-imagebox-services */}
                        </div>
