                    ...
                    <div className="container-xl">
                        <div className="row">
                            ...
                            <div className="title-box text-center">
                                ...
                                <h1 className="title">Our Expert</h1>
                                </div>
                ...
                <section className="ttm-row grid-section clearfix">
                    ...
                    <div className="row">
                        ...
                        <div className="featured-imagebox featured-imagebox-team style1 mb-30">
                            ...
                            <img className="img-fluid" src="https://via.placeholder.com/480X520/444444.jpg" alt="image" />
                            ...
                            <div className="featured-title">{/* featured-title */}
                                <h5><a href={process.env.PUBLIC_URL + '/Team_detail'}>Louis EKANI</a></h5>
                            </div>
                            <p className="category">CEO & Founder</p>{/* category */}
                            </div>
                        ...
                        <div className="featured-imagebox featured-imagebox-team style1 mb-30">
                            ...
                            <div className="featured-content box-shadow">
                            <div className="featured-title">{/* featured-title */}
                                <h5><a href={process.env.PUBLIC_URL + '/Team_detail'}>Kévin KENOUYA</a></h5>
                            </div>
                            <p className="category">CTO (web) & Co-Founder</p>{/* category */}
                            </div>
                        </div>{/* featured-imagebox-team end*/}
                        </div>
                        <div className="col-md-6 col-lg-4 col-sm-6">
                        ...
                        <div className="featured-imagebox featured-imagebox-team style1 mb-30">
                            ...
                            <div className="featured-content box-shadow">
                            <div className="featured-title">{/* featured-title */}
                                <h5><a href={process.env.PUBLIC_URL + '/Team_detail'}>Patrick KAMSSU</a></h5>
                            </div>
                            <p className="category">CTO (mobile) & Founder</p>{/* category */}
                            </div>
                        </div>{/* featured-imagebox-team end*/}
                        </div>
                        <div className="col-md-6 col-lg-4 col-sm-6">
